...
class gsp_cloudCommerce_camerashowAll_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/camera/showAll.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',97,['controller':("user"),'name':(item.Title),'action':("addToCart"),'id':(item.id)],5)
printHtmlPart(33)
})
...
public static final long LAST_MODIFIED = 1398413885709L
