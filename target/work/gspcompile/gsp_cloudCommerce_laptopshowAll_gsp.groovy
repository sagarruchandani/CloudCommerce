...
class gsp_cloudCommerce_laptopshowAll_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/laptop/showAll.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',73,['controller':("laptop"),'action':("hot")],2)
printHtmlPart(26)
...
public static final long LAST_MODIFIED = 1398752418034L
