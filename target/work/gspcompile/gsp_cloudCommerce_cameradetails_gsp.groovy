...
class gsp_cloudCommerce_cameradetails_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/camera/details.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('actionSubmit','g',94,['value':("addToCart"),'controller':("Laptop"),'action':("addToCart")],2)
printHtmlPart(39)
})
...
public static final long LAST_MODIFIED = 1398414367042L
